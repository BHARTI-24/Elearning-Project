...
<body onload="">
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-dark fixed-top">
		<a class="navbar-brand text-white" href="../admin_main.php">E-Learning System</a>
    ...
    <a class="nav-link" data-toggle="tab" href="#menu2">Menu 2</a>
				...
				<div class="tab-content">
					...
					<div class="tab-pane container active" id="home">
						<div class="card-header mt-3 mr-5 bg-white text-info border-0 shadow card1" style="width: 1050px; box-shadow: 1px 1px 1px 1px #ccc"><b>YOUR COURSE VIDEOS</b></div><br>
						<div class="row">
